...
import '../features/teacher/scanner_screen.dart';
...
class AppRoutes {
  ...
  static const String teacherScanner = '/teacher/scanner';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return PendingApprovalScreen(data: data);
        },
      ),
      GoRoute(
        path: forgotPassword,
      ...
      ShellRoute(
        builder: (context, state, child) {
          ...
          else if (loc.contains('attendance')) index = 2;
          else if (loc.contains('assessments')) index = 3;
          else if (loc.contains('schedule') || loc.contains('analytics') || loc.contains('reports')) index = 4;
        ...
        routes: [
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(
                path: 'rfid',
                builder: (context, state) {
                  final sectionId = state.extra as String? ?? '1';
                  return RfidAttendanceScreen(sectionId: sectionId);
                },
              ),
            ],
          ),
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return ItemAnalysisScreen(assessmentId: id);
            },
          ),
          GoRoute(
            path: teacherReports,
